...
void CIron_Tile::Init(LPCSTR pFile,D3DXVECTOR3 loadPos,float Size, LPCSTR pCollType, CShader* Shader)
{
	cmObject=new CMesh();
	...
	m_PhyData->Init_Phydata(1.0f,0.0f,0.3f,D3DXVECTOR3(0,0,0),D3DXVECTOR3(0,0,0));
	m_Material = 1;
	m_Material = 1;
}