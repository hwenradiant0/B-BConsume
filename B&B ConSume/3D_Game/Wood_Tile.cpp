...
void CWood_Tile::Init(LPCSTR pFile,D3DXVECTOR3 loadPos,float Size, LPCSTR pCollType, CShader* Shader)
{
	cmObject=new CMesh();
	...
	SetMeshColor(0, 0.60f , 0.45f, 0.12f,1.0f);

	m_PhyData->Init_Phydata(1.0f,1.0f,0.5f,D3DXVECTOR3(0,0,0),D3DXVECTOR3(0,0,0));
