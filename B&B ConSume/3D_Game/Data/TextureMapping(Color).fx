...
// Pass 0
//--------------------------------------------------------------//
string TextureMapping_Pass_0_Model : ModelData = "..\\..\\..\\Program Files\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\Sphere.x";
...
> = float4( 0.00, 0.00, 0.00, 1.00 );//<´X É
...
float4 TextureMapping_Pass_0_Pixel_Shader_ps_main(PS_INPUT Input) : COLOR
{
   ...
   return (albedo.rgba+ ObjectColor);
}
//--------------------------------------------------------------//
