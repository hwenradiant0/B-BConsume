...
// Pass 0
//--------------------------------------------------------------//
string ColorShader_Pass_0_Model : ModelData = "..\\..\\..\\Program Files\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\Sphere.x";
...
> = float4( 1.00, 1.00, 1.00, 1.00 );//<´X É
float4 ColorShader_Pass_0_Pixel_Shader_ps_main() : COLOR
{
   return float4(ObjectColor);
}
//--------------------------------------------------------------//
