...
void CWater_Tile::Init(LPCSTR pFile,D3DXVECTOR3 loadPos,float Size, LPCSTR pCollType, CShader* Shader)
{
	cmObject=new CMesh();
	...
	SetMeshColor(0, 0.0f , 0.0f ,1.0f,1.0f);
