...
void CBomb_Tile2::Init(LPCSTR pFile,D3DXVECTOR3 loadPos,float Size, LPCSTR pCollType, CShader* Shader)
{
	cmObject=new CMesh();
	...
	SetMeshColor(0, 1.0f , 1.0f, 1.0f,1.0f);
	m_PhyData->Init_Phydata(1.0f,20.0f,0.5f,D3DXVECTOR3(0,0,0),D3DXVECTOR3(0,0,0));
	m_Material = 14;
}