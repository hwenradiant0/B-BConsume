...
CParticle_Die::CParticle_Die(void)
{
	count = 0;
}
...
int CParticle_Die::Create(LPDIRECT3DTEXTURE9 pTex)
{
	m_pTex = pTex;
...
void CParticle_Die::SetRender(bool Render, D3DXVECTOR3 Pos)
{
	m_bRender = Render;
