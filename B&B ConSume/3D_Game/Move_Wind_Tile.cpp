...
CMove_Wind_Tile::CMove_Wind_Tile(void)
{
}
...
void CMove_Wind_Tile::SetPos(D3DXVECTOR3 Move)
{
	m_vPos=Move;
...
void CMove_Wind_Tile::Init(LPCSTR pFile,D3DXVECTOR3 loadPos,float Size, LPCSTR pCollType, CShader* Shader)
{
	cmObject=new CMesh();
	...
	m_PhyData->Init_Phydata(1.0f,10.0f,0.5f,D3DXVECTOR3(0,0,0),D3DXVECTOR3(0,0,0));
