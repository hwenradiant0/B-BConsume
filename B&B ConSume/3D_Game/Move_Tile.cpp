...
void CMove_Tile::SetPos(D3DXVECTOR3 Move)
{
	m_vPos=Move;
...
void CMove_Tile::Init(LPCSTR pFile,D3DXVECTOR3 loadPos,float Size, LPCSTR pCollType, CShader* Shader)
{
	cmObject=new CMesh();
